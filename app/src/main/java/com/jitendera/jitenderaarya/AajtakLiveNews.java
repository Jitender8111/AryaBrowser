...
public class AajtakLiveNews extends AppCompatActivity {
    private String aajtak = "https://feeds.intoday.in/aajtak/api/master.m3u8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //-------------------------------------end ----------------------------------------------------
        setContentView(R.layout.activity_aajtak_live_news);

        MediaController mediaController =  new MediaController(this);


        VideoViewLivetv = findViewById(R.id.VideoViewLivetvAajtak);
    ...
    private void playVideo() {
        ...
        try{
            ...
            Uri videourls = Uri.parse(aajtak);
