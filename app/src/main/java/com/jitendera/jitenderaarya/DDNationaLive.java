...
public class DDNationaLive extends AppCompatActivity {

   /* private String DDnat = "http://103.199.160.85/Content/moviehouse/Live/Channel(MovieHouse)/Stream(01)/index.m3u8";*/
    private String DDnational = "http://m-c036-j2apps.s.llnwi.net/hls/0098.DDNational.in.m3u8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //-------------------------------------end ----------------------------------------------------
        setContentView(R.layout.activity_ddnationa_live);

        MediaController mediaController =  new MediaController(this);


        VideoViewLivetv = findViewById(R.id.VideoViewLivetvDDnatioanl);
    ...
    private void playVideo() {
        ...
        try{
            ...
            Uri videourls = Uri.parse(DDnational);
