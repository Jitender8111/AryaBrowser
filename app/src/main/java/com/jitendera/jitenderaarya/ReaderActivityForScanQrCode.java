...
public class ReaderActivityForScanQrCode extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reader_for_scan_qr_code);
    ...
    public void handleResult(Result result) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                scannerView.resumeCameraPreview(ReaderActivityForScanQrCode.this);
            }
        ...
        builder.setNeutralButton("Visit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ReaderActivityForScanQrCode.this,MainActivity.class);
